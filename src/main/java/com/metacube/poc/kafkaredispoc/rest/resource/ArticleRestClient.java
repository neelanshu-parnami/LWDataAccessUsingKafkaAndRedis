...
public class ArticleRestClient {
	public void getArticleByIdDemo() {
		...
		String url = "http://localhost:8080/rest/article/{id}";
	...
	public void getAllArticlesDemo() {
		...
		headers.setContentType(MediaType.APPLICATION_JSON);
		RestTemplate restTemplate = new RestTemplate();
		String url = "http://localhost:8080/rest/articles";
		HttpEntity<String> requestEntity = new HttpEntity<String>(headers);
		ResponseEntity<Article[]> responseEntity = restTemplate.exchange(url, HttpMethod.GET, requestEntity,
				Article[].class);
	...
	public void addArticleDemo() {
		...
		headers.setContentType(MediaType.APPLICATION_JSON);
		RestTemplate restTemplate = new RestTemplate();
		String url = "http://localhost:8080/rest/article";
	...
	public static void main(String args[]) {
		ArticleRestClient util = new ArticleRestClient();
